...
- Prefer to compress memory rather than trigger OOM. This optimization reduces panic OOM situations, but doesn't eliminate them yet; after all, each device has its own multitasking limitations
